...
WriteCacheClient::list_tables(uint64_t db_id, uint64_t xid, uint32_t count, uint64_t &cursor)
{
    ...
    _invoke_with_retries(
        [&response, &request](ThriftClient &c) { c.client->list_tables(response, request); });
...
WriteCacheClient::get_extents(
    uint64_t db_id, uint64_t tid, uint64_t xid, uint32_t count, uint64_t &cursor)
{
    ...
    _invoke_with_retries(
        [&response, &request](ThriftClient &c) { c.client->get_extents(response, request); });
...
WriteCacheClient::evict_table(uint64_t db_id, uint64_t tid, uint64_t xid)
{
    ...
    _invoke_with_retries(
        [&result, &request](ThriftClient &c) { c.client->evict_table(result, request); });
...
WriteCacheClient::evict_xid(uint64_t db_id, uint64_t xid)
{
    ...
    _invoke_with_retries(
        [&result, &request](ThriftClient &c) { c.client->evict_xid(result, request); });
                              ...
                              const std::vector<uint64_t> &new_eids)
{
    ...
    _invoke_with_retries(
        [&result, &request](ThriftClient &c) { c.client->add_mapping(result, request); });
...
WriteCacheClient::set_lookup(uint64_t db_id, uint64_t tid, uint64_t target_xid, uint64_t extent_id)
{
    ...
    _invoke_with_retries(
        [&result, &request](ThriftClient &c) { c.client->set_lookup(result, request); });
...
WriteCacheClient::forward_map(uint64_t db_id, uint64_t tid, uint64_t target_xid, uint64_t extent_id)
{
    ...
    _invoke_with_retries(
        [&result, &request](ThriftClient &c) { c.client->forward_map(result, request); });
    ...
    uint64_t db_id, uint64_t tid, uint64_t access_xid, uint64_t target_xid, uint64_t extent_id)
{
    ...
    _invoke_with_retries(
        [&result, &request](ThriftClient &c) { c.client->reverse_map(result, request); });
...
WriteCacheClient::expire_map(uint64_t db_id, uint64_t tid, uint64_t commit_xid)
{
    ...
    _invoke_with_retries(
        [&result, &request](ThriftClient &c) { c.client->expire_map(result, request); });
