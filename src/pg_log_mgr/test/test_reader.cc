...
public:
    ...
    PgLogWriterPtr create_log_writer() { return _create_repl_logger(); }

    PgXactLogWriterPtr create_xact_log_writer() { return _create_xact_logger(); }

    void process_xact(PgTransactionPtr xact) { _process_xact(xact); }
};
