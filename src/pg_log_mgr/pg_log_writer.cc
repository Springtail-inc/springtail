...
namespace springtail::pg_log_mgr {
    ...
    PgLogWriter::log_data(const PgCopyData &data)
    {
        ...
        if (data.msg_offset == 0) {
            ...
            LOG_DEBUG(LOG_PG_LOG_MGR_DATA, LOG_LEVEL_DEBUG1, "Write repl message start: start lsn={}, length={}, msg_length={}",
        ...
        if (data.msg_offset + data.length == data.msg_length) {
            ...
            LOG_DEBUG(LOG_PG_LOG_MGR_DATA, LOG_LEVEL_DEBUG1, "Write repl message end: start lsn={}, length={}, msg_length={}",
