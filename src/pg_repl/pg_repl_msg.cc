...
void
dump_tuple(const PgMsgTupleData &tuple, std::stringstream &ss) noexcept
{
...
dump_msg(const PgMsg &msg)
{
    ...
    switch (msg.msg_type) {
        case BEGIN: {
            ...
            ss << "  LSN=" << begin.xact_lsn << " (" << lsn_to_str(begin.xact_lsn) << ")\n";
            break;
        }
        ...
        case COMMIT: {
            ...
            ss << "\nCOMMIT" << std::endl;
            ss << "  commit LSN=" << commit.commit_lsn << " (" << lsn_to_str(commit.commit_lsn)
               << ")\n";
            ss << "  xact LSN=" << commit.xact_lsn << " (" << lsn_to_str(commit.xact_lsn) << ")\n";
            break;
        }
        ...
        case ORIGIN: {
            ...
            ss << "\nORIGIN" << std::endl;
            ss << "  commit LSN=" << origin.commit_lsn << " (" << lsn_to_str(origin.commit_lsn)
               << ")\n";
        ...
        case MESSAGE: {
            ...
            ss << "  LSN=" << message.lsn << " (" << lsn_to_str(message.lsn) << ")\n";
