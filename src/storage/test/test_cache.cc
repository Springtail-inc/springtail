...
protected:
    void SetUp() override
    {
        ...
        std::vector<SchemaColumn> columns({{"table_id", 0, SchemaType::INT64, 0, false},
    ...
    void TearDown() override { std::filesystem::remove_all(_base_dir); }
...
INSTANTIATE_TEST_CASE_P(StorageCache_Test,
                        StorageCache_Test,
                        ::testing::Values(CacheSize{16384, 16384, 512, 16}, CacheSize{8, 8, 2, 4}));
}  // namespace
