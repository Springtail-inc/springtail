...
typedef struct
{
	...
	uint8_t		comb_class;		/* combining class of character */
	uint8_t		dec_size_flags; /* size and flags of decomposition code list */
	uint16_t		dec_index;		/* index into UnicodeDecomp_codepoints, or the
...
/* codepoints array  */
static const uint32_t UnicodeDecomp_codepoints[5092] =
{
	 /* 0 */ 0x0020, 0x0308,
	 /* 2 */ 0x0020, 0x0304,
	 /* 4 */ 0x0020, 0x0301,
