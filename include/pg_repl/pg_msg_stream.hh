...
namespace springtail {
    ...
    protected:
        ...
        PgMsgPtr _decode_attach_partition(const PgMsgMessage &message, char *buffer, int len);
        PgMsgPtr _decode_detach_partition(const PgMsgMessage &message, char *buffer, int len);
