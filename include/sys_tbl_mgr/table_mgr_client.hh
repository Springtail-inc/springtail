...
namespace springtail {
    ...
    public:
         ...
         */
        virtual TablePtr
        get_table(uint64_t db_id, uint64_t table_id, uint64_t xid, ComparatorFunc comparator_func = nullptr) override;
        ...
        get_extent_schema(uint64_t db_id, uint64_t table_id,
                          const XidLsn &xid, ComparatorFunc comparator_func, bool allow_undefined = false) override;
    ...
    public:
        ...
        {
            return TableMgrClient::get_instance()->get_extent_schema(_db_id, _id, XidLsn(_xid), _comparator_func);
        }
