...
private:
     ...
     */
    bool _upsert_index_name(uint64_t db_id, uint64_t index_id, const proto::IndexInfo& index_info,
            const XidLsn& xid, const std::map<uint32_t, uint32_t>& keys, bool is_primary_index=false);
