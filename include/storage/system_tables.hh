...
namespace springtail::sys_tbl {
    ...
    public:
        ...
        struct Data {
            ...
            constexpr uint32_t TABLE_ID = 2;
            constexpr uint32_t XID = 3;
            constexpr uint32_t LSN = 4;
            constexpr uint32_t EXISTS = 5;
        ...
        struct Primary {
            constexpr uint32_t NAMESPACE = 0;
            constexpr uint32_t NAME = 1;
            constexpr uint32_t XID = 2;
            constexpr uint32_t LSN = 3;
            constexpr uint32_t EXTENT_ID = 4;

            static const std::vector<SchemaColumn> SCHEMA;
        };

        struct Secondary {
            constexpr uint32_t TABLE_ID = 0;
            constexpr uint32_t XID = 1;
            constexpr uint32_t LSN = 2;
            constexpr uint32_t EXTENT_ID = 3;
            constexpr uint32_t ROW_ID = 4;
    ...
    public:
        ...
        struct Primary {
            constexpr uint64_t TABLE_ID = 0;
            constexpr uint64_t INDEX_ID = 1;
            constexpr uint64_t XID = 2;
            constexpr uint64_t EXTENT_ID = 3;
    ...
    class Indexes {
    public:
        static constexpr uint32_t TABLE_ID = 3;
        ...
        struct Data {
            ...
            constexpr uint32_t COLUMN_ID = 4;
    ...
    class Schemas {
    public:
        static constexpr uint32_t TABLE_ID = 4;
        ...
        struct Data {
            ...
            constexpr uint32_t XID = 2;
            constexpr uint32_t LSN = 3;
            constexpr uint32_t EXISTS = 4;
            constexpr uint32_t NAME = 5;
            constexpr uint32_t TYPE = 6;
            constexpr uint32_t NULLABLE = 7;
            constexpr uint32_t DEFAULT = 8;
            constexpr uint32_t UPDATE_TYPE = 9;
