...
namespace springtail {
    ...
    public:
        ...
        void write(uint64_t offset, const std::vector<std::vector<char>> &data, io_write_callback_fn callback);

        void append(const std::vector<char> &data, std::shared_ptr<Compressor> compressor, io_write_callback_fn callback);

        void append(const std::vector<std::vector<char>> &data, std::shared_ptr<Compressor> compressor, io_write_callback_fn callback);
