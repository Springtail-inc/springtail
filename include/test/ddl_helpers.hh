...
namespace springtail::test::ddl_helpers {
    ...
    sys_tbl_mgr::Server::IndexProcessRequest create_index(uint64_t db_id, uint64_t table_id, uint64_t xid, uint64_t index_id, std::string idx_name,
            std::vector<PgMsgSchemaColumn> columns, sys_tbl::IndexNames::State idx_state, bool is_unique=false);
