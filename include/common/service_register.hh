...
namespace springtail {
    class ServiceRunner {
    public:
        ServiceRunner(std::string name) : _name(name) {}
        ...
        virtual void stop() {
            SPDLOG_INFO("Default stop for service {}", _name);
        }
    ...
    public:
        ...
        void _internal_shutdown() override {
            for (auto reverse_iter = _service_list.rbegin();
                            reverse_iter != _service_list.rend(); reverse_iter++) {
