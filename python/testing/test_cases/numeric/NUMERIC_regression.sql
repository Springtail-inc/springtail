...
INSERT INTO fract_only VALUES (10, '.04353023451866590387054959174736129501310680280823383331007646306243540953499740615246583399296334239109936336446284803020643582102868247857009494139535009572740621288230740389545481395');
INSERT INTO fract_only VALUES (10, '-.04353023451866590387054959174736129501310680280823383331007646306243540953499740615246583399296334239109936336446284803020643582102868247857009494139535009572740621288230740389545481395');
...
SELECT * FROM num_data ORDER BY id;
SELECT * FROM num_exp_add ORDER BY id1, id2;
SELECT * FROM num_exp_sub ORDER BY id1, id2;
SELECT * FROM num_exp_div ORDER BY id1, id2;
SELECT * FROM num_exp_mul ORDER BY id1, id2;
SELECT * FROM num_exp_sqrt ORDER BY id;
SELECT * FROM num_exp_ln ORDER BY id;
SELECT * FROM num_exp_log10 ORDER BY id;
SELECT * FROM num_exp_power_10_ln ORDER BY id;

SELECT * FROM num_result ORDER BY id1, id2;
...
SELECT to_char(val, 'MI9999999999999999.999999999999999')     FROM num_data ORDER BY id;
SELECT to_char(val, 'FMS9999999999999999.999999999999999')    FROM num_data ORDER BY id;
SELECT to_char(val, 'FM9999999999999999.999999999999999THPR') FROM num_data ORDER BY id;
SELECT to_char(val, 'SG9999999999999999.999999999999999th')   FROM num_data ORDER BY id;
SELECT to_char(val, '0999999999999999.999999999999999')       FROM num_data ORDER BY id;
SELECT to_char(val, 'S0999999999999999.999999999999999')      FROM num_data ORDER BY id;
SELECT to_char(val, 'FM0999999999999999.999999999999999')     FROM num_data ORDER BY id;
SELECT to_char(val, 'FM9999999999999999.099999999999999') 	FROM num_data ORDER BY id;
SELECT to_char(val, 'FM9999999999990999.990999999999999') 	FROM num_data ORDER BY id;
SELECT to_char(val, 'FM0999999999999999.999909999999999') 	FROM num_data ORDER BY id;
SELECT to_char(val, 'FM9999999990999999.099999999999999') 	FROM num_data ORDER BY id;
-- see SPR-884; SELECT to_char(val, 'L9999999999999999.099999999999999')	FROM num_data ORDER BY id;
SELECT to_char(val, 'FM9999999999999999.99999999999999')	FROM num_data ORDER BY id;
SELECT to_char(val, 'S 9 9 9 9 9 9 9 9 9 9 9 9 9 9 9 9 . 9 9 9 9 9 9 9 9 9 9 9 9 9 9 9 9 9') FROM num_data ORDER BY id;
SELECT to_char(val, 'FMS 9 9 9 9 9 9 9 9 9 9 9 9 9 9 9 9 . 9 9 9 9 9 9 9 9 9 9 9 9 9 9 9 9 9') FROM num_data ORDER BY id;
SELECT to_char(val, E'99999 "text" 9999 "9999" 999 "\\"text between quote marks\\"" 9999') FROM num_data ORDER BY id;
SELECT to_char(val, '999999SG9999999999')			FROM num_data ORDER BY id;
SELECT to_char(val, 'FM9999999999999999.999999999999999')	FROM num_data ORDER BY id;
...
SELECT trim_scale(variance(a) * 1e1000) AS t FROM num_variance ORDER BY t;
SELECT variance(a) AS v FROM num_variance ORDER BY v;
