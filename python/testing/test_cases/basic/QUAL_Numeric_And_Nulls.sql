...
CREATE INDEX numeric_and_nulls_idx_col9 ON numeric_and_nulls (col9);
...
-- check type comparison using index
SELECT col9 FROM numeric_and_nulls WHERE col9 > 25::integer ORDER BY col9;
