...
CREATE INDEX time_and_nulls_idx_col3 ON time_and_nulls (col3);
CREATE INDEX time_and_nulls_idx_col4_col5 ON time_and_nulls (col4, col5);
CREATE INDEX time_and_nulls_idx_col7 ON time_and_nulls (col7);

INSERT INTO time_and_nulls (col1, col2, col3, col4, col5, col6, col8, col9) 
VALUES 
...
-- col3 < Specific Date
SELECT col3 FROM time_and_nulls WHERE col3 < '2025-02-05' ORDER BY col3 DESC;

-- col3 < Between Dates
SELECT col3 FROM time_and_nulls WHERE col3 BETWEEN '2025-02-05' AND '2025-02-15' ORDER BY col3 ASC;

-- col3 IS NULL
SELECT col3 FROM time_and_nulls WHERE col3 IS NULL ORDER BY col3 ASC;

-- col3 IS NOT NULL
SELECT col3 FROM time_and_nulls WHERE col3 IS NOT NULL ORDER BY col3 ASC;


## cleanup
DROP TABLE IF EXISTS time_and_nulls;