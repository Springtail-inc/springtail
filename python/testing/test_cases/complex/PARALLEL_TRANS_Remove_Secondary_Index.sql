...
CREATE INDEX idx_amount ON parallel_trans_remove_secondary_index (amount);

CREATE INDEX idx_item_name_category ON parallel_trans_remove_secondary_index (item_name, category);
...
### sleep 4
DROP INDEX idx_item_name_category;
